...
public class HousePriceFieldsSolution {
    public static void main(String[] args) {
        ...
        //   System.out.println("Correlacao: " + col + " is: "+ csvData.stat().corr("price", col));
        //}
        ...
        for (String col1: csvData.columns()){
            for (String col2 : csvData.columns()){
                System.out.println("Correlacao: " + col1 +" and " + col2 + " is: "+ csvData.stat().corr(col1, col2));
            }
        }
    }
}
